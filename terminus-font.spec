...
Source0:        http://downloads.sourceforge.net/project/terminus-font/terminus-font-4.46/%{name}-%{version}.tar.gz
BuildRequires:  perl
...
%__sed -e 's/.pcf.gz//' %{buildroot}%{fontdir}/fonts.dir|grep terminus > %{buildroot}%{fontdir}/fonts.alias
